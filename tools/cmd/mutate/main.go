...
//
// Отсюда правило: проверка, которую ни разу не видели красной, не проверка, а
...
var mutations = []mutation{
	...
	{"кнопка сравнялась с подложкой", "contrast", "src/tokens.css",
		"--surface-recessed:        light-dark(oklch(0 0 0 / 0.060), oklch(1 0 0 / 0.035));",
	...
	{"лестница: наведение сравнялось с умолчанием", "contrast", "src/tokens.css",
		"--surface-recessed-hover:  light-dark(oklch(0 0 0 / 0.025), oklch(1 0 0 / 0.070));",
		"--surface-recessed-hover:  light-dark(oklch(0 0 0 / 0.058), oklch(1 0 0 / 0.036));",
	...
	{"число в таблице токенов соврало", "docscheck", "docs/foundations/tokens.md",
		"| `--surface-recessed` | чёрный 6% | белый 3.5% |",
		"| `--surface-recessed` | чёрный 9% | белый 3.5% |",
