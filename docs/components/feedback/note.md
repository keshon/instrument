...
|---|---|---|
| `aria-live="polite"` на контейнере | да, если сноска появилась в ответ на действие | Кит роли не ставит: он не знает, появилась она сейчас или была изначально |
...
Иначе для скринридера ничего не произошло. Кит роли не ставит: он не знает,
