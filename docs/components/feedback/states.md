...
| Каретка вплотную к последнему знаку | да | Отбивка ровно на просвет, `0.1em`. Отодвинутая на пробел каретка показывает не туда |
...
- **Стоит вплотную к последнему знаку**, отбивка ровно на просвет (`0.1em`).
  Каретка, отодвинутая на пробел, показывает не туда.
- **Мигает ступенями** (`steps(2, start)`), а не плавно: затухающая каретка
  читается как артефакт отрисовки, а не как активность.
