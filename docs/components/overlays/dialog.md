...
:::do Нативный dialog и showModal
...
:::do Разрушительное действие подписано глаголом
«Удалить», а не «ОК». Кнопка в подвале — последнее, что читают перед
необратимым.
:::

:::dont Модалка ради сообщения
Если вопроса нет, нужен [баннер](../feedback/banner.md): модалка требует
нажатия там, где хватило бы прочтения.
:::
