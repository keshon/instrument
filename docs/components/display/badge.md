...
|---|---|
| Состояние из перечислимого набора: идёт, готово, упало | **Произвольный текст, заведённый пользователем** — [тег](./tag.md). Бейдж — словарь библиотеки, тег — слова пользователя, и снять его можно |
