...
|---|---|
| Метка, заведённая пользователем и снимаемая | **Состояние из словаря библиотеки** — [бейдж](./badge.md) |
...
Тег **не имеет тона**: раскрасить пользовательские метки в статусные
цвета значит соврать про их смысл. Если метка кодирует состояние — это бейдж.

| | Тег | [Бейдж](./badge.md) |
|---|---|---|
| Откуда текст | От пользователя | Из словаря библиотеки |
