...
[конституции](../../about/design-principles.md) поимённо, и вместе с ним
оговорены пять правил, которых нет больше нигде в ките.
...
Выбрана намеренно: при дальтонизме и на чёрно-белой печати тон исчезает, а
яркость остаётся.
:::
