...
каким это называет `inst-history-tick`, — нарисованное дорожкой, потому что
образец, который не рисует ничего, это пропавший образец, а не запись об
отсутствии.
...
История отвечает на **когда**, состав — на **сколько**, и экрану аптайма нужны
оба. Сравнение стоит в [индексе раздела](./index.md).
