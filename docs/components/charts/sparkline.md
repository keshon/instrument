...
| Контраст | Линия берёт категориальный тон и держит 3:1 против поверхности в пяти темах. Заливка с альфой `0.12` — декоративная и на порог не проверяется: значение несёт линия |
