...
| Одна величина, у которой есть потолок | **Несколько долей, складывающихся в целое** — это не кольцо, а [легенда](./legend.md) с рядами: кольцо здесь однодуговое |
