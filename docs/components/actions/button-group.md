...
**Шов — снятая рамка у соседа, а не отрицательное поле в `-0.5px`.** Браузер
никогда не рисует рамку тоньше физического пикселя, поэтому сдвиг на
полпикселя оставлял видимое утолщение на каждом стыке. Скругление снимается у
всех и возвращается только крайним — на односторонней рамке радиус всегда баг.
