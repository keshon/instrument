...
переезжать нечему: весь этот текст **уже есть в `DESIGN.md`, дословно**. То
...
| «Нажатие — `scale(0.985)`, а не `0.95`» | Остаётся в `DESIGN.md`. Философия системы, а не инструкция |
