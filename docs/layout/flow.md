...
кнопка во всю ширину карточки — тот же признак самодельного кита, что и
иконочная кнопка прямоугольником. Поля и карточки ширину колонки, наоборот,
занимают. Список закрытый и совпадает с инлайновыми компонентами кита.
...
рассуждение — в [конституции](../about/design-principles.md).
