...
Чёрный в обеих темах, в отличие от `--surface-hover`: утопление — это всегда
вниз. В светлых темах шаг вчетверо мельче, потому что чёрный на белом набирает
светлоту быстрее и те же 20% дали бы серый кирпич.
