...
| `--surface-recessed-hover` | чёрный 2.5% | белый 7% |
| `--surface-recessed-active` | чёрный 7.5% | белый 1.2% |
...
обязана отличаться от своей подложки на различимую ступень. Лестница состояний
при этом читается физически и одинаково в обе стороны — наведение поднимает
контрол от подложки, нажатие возвращает к ней; меняется только знак плёнки.
