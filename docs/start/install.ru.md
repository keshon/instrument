...
Без спрайта работает всё остальное, иконки просто не рисуются. Полный список —
на странице [иконок](../foundations/icons.md), и число стоит только там: число,
повторённое во втором месте, расходится со спрайтом на первом же добавленном
символе.
