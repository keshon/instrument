...
:::do Нативный details
Раскрытие, клавиатура, поиск по странице и раскрытие при печати приходят от
платформы.
:::

:::dont Свой раскрыватель на кнопке
Он теряет поиск по странице и раскрытие на печати — то есть ровно то, ради чего
вывод и сохраняют.
:::

:::do data-truncated у обрезанного вывода
Читатель обязан знать, что показано не всё, до того как сделает вывод.
:::

:::dont Полный вывод инструмента в шапке
Шапка — это имя вызова, аргумент и время. Тело раскрывается по требованию.
:::
