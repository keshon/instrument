...
:::do Прогноз рядом с остатком
«Хватит ещё примерно на 3 прогона» отвечает на вопрос, ради которого сюда
смотрят. Голое число — нет.
:::

:::dont Только процент
74% от неизвестного целого не сообщает ничего. Абсолютные значения обязательны.
:::

:::do «из N» внутри значения
Это часть числа. Отдельным узлом рядом оно читается вторым показателем.
:::

:::dont Тон по проценту
Красный на 80% там, где 80% — норма, обучает игнорировать красный.
:::
