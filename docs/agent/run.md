...
needs-js: Живые числа и остановка — слой приложения. Свёртка фаз работает без скрипта
api:
...
Экран, который не собирается из кита, означает дыру в ките, а не потребность в
ещё одном классе.
:::
